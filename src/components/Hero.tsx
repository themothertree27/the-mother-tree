        ...
        <div ref={elementsRef} className="stagger-animation max-w-4xl">
          ...
          {isMobile ? (
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-medium tracking-tight mb-6">
              <span className="text-gray-600 block">Welcome to</span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 -mt-2">
            <a href="#membership" className={`${isMobile ? 'px-4 py-2 text-sm mt-20' : 'px-8 py-4'} rounded-full bg-nature-leaf text-white font-medium button-effect transform transition duration-300 hover:shadow-xl hover:scale-105`}>The Giving-Back Tree</a>
