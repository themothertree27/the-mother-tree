      ...
      <div className="container mx-auto px-6 h-full flex flex-col justify-center items-center text-center relative z-10">
        ...
        <div ref={elementsRef} className="stagger-animation max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 -mt-2">
            <a href="#membership" className={`${isMobile ? 'px-4 py-2 text-sm mt-6' : 'px-8 py-4'} rounded-full bg-nature-leaf text-white font-medium button-effect transform transition duration-300 hover:shadow-xl hover:scale-105`}>The Giving-Back Tree</a>
