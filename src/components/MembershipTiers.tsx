      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          transitionDelay: '0.4s'
            ...
            <MembershipCard tier="LEVEL 2" name="Rooted Membership" price="$777 add-on membership" description="We want The Mother Tree to be watered by the very people who planted it. Rooted in the ethos of community, we will be co-operatively-funded-and-sustained by our members. What we do with our profits will be collectively decided upon by those with Rooted membership, where we'll invest back into the community and all of our members' dreams." benefits={["Exclusive perks", "Vote in monthly meetings for where profit should be allocated", "Legacy Donor"]} accentColor="text-nature-soil" iconColor="bg-nature-soil/10" bgGradient="bg-gradient-to-br from-nature-soil/90 to-nature-soil" icon={<Sprout />} buttonIcon={<Sprout />} buttonText="Rooted" buttonBgColor="bg-nature-soil" />
          </div>
          ...
          transitionDelay: '0.6s'
            ...
            <MembershipCard tier="LEVEL 3" name="The Mother Board" price="$1111+ investment" description="If you ain't making your Momma or Momma Earth proud, what are you doing?! The Mother Tree is not only our chance to build something that our Mothers will be proud of, it will be something they will be A PART OF! At this level of giving, your Mother* will be invited to become an honorary board member. Together, they will be known as The Mother Board, whose divine guidance, direction, and belief will lead The Mother Tree to much success and bring us all one step closer to the Matriarchy." benefits={["Equity of The Mother Tree through a SAFE investment", "Invitation for a mother-figure in your life to be an honorary board member", "Legacy Donor"]} exclusions={["Does not include Rooted Membership"]} accentColor="text-nature-leaf" iconColor="bg-nature-leaf/10" bgGradient="bg-gradient-to-br from-nature-leaf/90 to-nature-leaf" icon={<TreePine />} buttonIcon={<TreePine />} buttonText="The Mother Board" clarificationText="*Mother, Mother-Figure, or Angel Mom (Rest in Peace <3)" />
          </div>
        </div>
