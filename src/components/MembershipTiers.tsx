        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="animate-scroll-in" style={{
            ...
            <MembershipCard 
              ...
              benefits={["Equity of The Mother Tree through a SAFE investment", "Invitation for a mother-figure in your life to be an honorary board member", "Legacy Donor"]} 
              ...
              clarificationText="*Mother, Mother-Figure, or Angel Mother (Rest in Peace <3)" 
            />
          </div>
        </div>
