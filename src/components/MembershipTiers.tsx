...
const MembershipTiers = () => {
  return (
    <section id="membership" className="section-padding relative overflow-hidden bg-gray-50/50">
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 animate-scroll-in">
          ...
          <p className="text-gray-600">
            Join our nurturing community with the membership tier that resonates with your journey.
            Each level offers unique benefits while supporting our shared mission.
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {/* Tier 1: Be-leave'rs */}
          <div className="animate-scroll-in" style={{ transitionDelay: '0.2s' }}>
            <MembershipCard
              tier="LEVEL 1"
              name="Be-leave'rs"
              price="$222 one-time"
          ...
          <div className="animate-scroll-in" style={{ transitionDelay: '0.4s' }}>
            <MembershipCard
              tier="LEVEL 2"
              ...
              benefits={[
                ...
                "1:1 quarterly guidance sessions",
          ...
          <div className="animate-scroll-in" style={{ transitionDelay: '0.6s' }}>
            <MembershipCard
              tier="LEVEL 3"
              ...
              benefits={[
                ...
                "VIP early access to new initiatives"
              ]}
