      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          transitionDelay: '0.2s'
            ...
            <MembershipCard tier="LEVEL 1" name="Be-leave'rs" price="$222 one-time" description="Your first step into our community, with essentials to begin your journey." benefits={["Welcome gift package", "Monthly digital newsletter", "Access to community forums", "Exclusive digital content", "10% discount on workshops"]} accentColor="text-nature-leaf" iconColor="bg-nature-leaf/10" bgGradient="bg-gradient-to-br from-nature-leaf/90 to-nature-leaf" icon={<Leaf className="h-6 w-6 text-nature-leaf" />} />
          </div>
          ...
          transitionDelay: '0.6s'
            ...
            <MembershipCard tier="LEVEL 3" name="The Mother Board" price="$1111+ donation" description="Become a guardian of our mission with the highest level of connection and influence." benefits={["All Rooted Membership benefits", "Exclusive retreat invitation", "Advisory board participation", "Personalized support pathway", "Recognition on our platform", "Unlimited access to all resources", "VIP early access to new initiatives"]} accentColor="text-nature-soil" iconColor="bg-nature-soil/10" bgGradient="bg-gradient-to-br from-nature-soil/90 to-nature-soil" icon={<TreePine className="h-6 w-6 text-nature-soil" />} />
          </div>
        </div>
