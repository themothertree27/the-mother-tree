        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-scroll-in">
              ...
              <p className="mb-6 text-left text-gray-600">The Mother Tree is a magical mecca for all our members of the urban jungle to gather. It is a place for us to find our roots, plant our seeds, and grow our community. A refuge for culture, candor, and connection with nature. A dwelling for learning, yearning, and revolutionizing. Where we can come together to radicalize our intentions and mobilize our movements. Where the mightiest and mindful minds meet to reenvision economies and co-create technologies that regenerate our planet and our souls. It is a forest to cultivate our wildest dreams. The Mother Tree is our way home.</p>
              <p className="text-gray-600 mb-8 font-normal">Rooted in the power of presence, The Mother Tree plants the dreaming seed in each of us, helping us find our truest selves, reconnecting us back to nature, and creating a community dedicated to art, activism, and ancestral wisdom. It represents the interconnected network that sustains old growth forests. Like these natural systems, our community thrives through connection, mutual support, and the sharing of resources. The Mother Tree is a convergence of culture and trust, where ideas and creations for a better today begin to grow. We hope this first Mother Tree will begin the replanting of a whole forest of Mother Trees, inspiring communities across the world that empower co-creation and collaboration for the posterity of our people and the planet.</p>
      ...
      <section id="spaces" className="pb-20 pt-10 px-6 md:px-12 lg:px-24 relative overflow-hidden bg-gradient-to-b from-white to-nature-leaf/5">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center mb-12 animate-scroll-in">
            ...
            <p className="text-gray-600 mx-auto max-w-2xl">The Mother Tree is the brick & mortar headquarters for the convergence of its member's artistic, communal, societal, political, and entrepreneurial endeavors. It is the epicenter 
for economic envisioning, entertainment creation, and technological invention 
& adaptation that will bring us all closer to nature.</p>
          </div>
...
Wellness Space</h3>
            ...
            <div className="p-6 rounded-xl bg-white shadow-md hover:shadow-xl transition-all">
              <div className="rounded-full w-12 h-12 flex items-center justify-center bg-nature-leaf/10 mb-4">
                <TreeDeciduous className="w-6 h-6 text-nature-leaf" />
              </div>
