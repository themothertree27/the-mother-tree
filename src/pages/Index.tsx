...
const Index = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-scroll-in">
              ...
              <p className="text-gray-600 mb-6">
                The Mother Tree represents the interconnected network that sustains forests. 
                Like these natural systems, our community thrives through connection, mutual support, 
                and the sharing of resources.
              </p>
              <p className="text-gray-600 mb-8">
                We believe in nurturing relationships between people and the natural world, 
                creating spaces for growth, learning, and collective wisdom.
              </p>
            ...
            <div className="relative h-[500px] animate-scroll-in" style={{ transitionDelay: '0.3s' }}>
              <div className="absolute inset-0 grid grid-cols-2 grid-rows-2 gap-4">
                ...
                <div className="relative rounded-2xl overflow-hidden">
                  ...
                  <img 
                    src="https://images.unsplash.com/photo-1475483768296-6163e08872a1?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                    alt="Meditation" 
                    className="w-full h-full object-cover"
                  />
                </div>
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-scroll-in">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="#membership"
                className="px-8 py-4 rounded-full bg-nature-leaf text-white font-medium transform transition duration-300 hover:shadow-xl hover:translate-y-[-2px]"
              >
      ...
      <a
        href="#"
        className="fixed bottom-6 right-6 p-3 rounded-full bg-white shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-110 z-50"
        onClick={(e) => {
          e.preventDefault();
      ...
      >
        <svg
          className="w-5 h-5 text-nature-leaf"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
