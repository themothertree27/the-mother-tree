        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-scroll-in">
              ...
              <p className="text-gray-600 mb-8">The Mother Tree represents the interconnected network that sustains old growth forests. Like these natural systems, our community thrives through connection, mutual support, and the sharing of resources.</p>
            ...
            transitionDelay: '0.3s'
              ...
              <div className="absolute inset-0 grid grid-cols-2 grid-rows-2 gap-4">
                ...
                <div className="relative rounded-2xl overflow-hidden">
                  ...
                  <img src="https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Snowy Forest" className="w-full h-full object-cover" />
                </div>
                <div className="relative rounded-2xl overflow-hidden">
